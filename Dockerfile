...
RUN apt-get install -y whois libjpeg-dev libcurl4-openssl-dev && chmod 777 /mkusers.sh && /mkusers.sh && chmod 777 /SQLSERVERODBCINSTALL.sh && /SQLSERVERODBCINSTALL.sh
